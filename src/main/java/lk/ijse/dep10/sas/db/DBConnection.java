...
public class DBConnection {
    ...
    private DBConnection() {
        ...
        try {
            ...
            String database = configurations.getProperty("dep10.sas.db.database", "dep10_system");
            ...
            String url2 = String.format("jdbc:mysql://%s:%s/%s?%s", host, port, database, queryString);
            ...
            new Alert(Alert.AlertType.ERROR, "Failed to establish the database connection, try again. If the problem persist please contact technical team").showAndWait();
            throw new RuntimeException(e);
        }
